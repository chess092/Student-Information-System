...
Begin VB.Form Form1 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(28)=   "Frame1"
      Tab(1).Control(28).Enabled=   0   'False
      Tab(1).Control(29)=   "List4"
      Tab(1).Control(29).Enabled=   0   'False
      Tab(1).Control(30)=   "Check1"
      Tab(1).Control(30).Enabled=   0   'False
      Tab(1).Control(31)=   "Check2"
      Tab(1).Control(31).Enabled=   0   'False
      Tab(1).Control(32)=   "Check3"
      Tab(1).Control(32).Enabled=   0   'False
      Tab(1).Control(33)=   "Check4"
      Tab(1).Control(33).Enabled=   0   'False
      Tab(1).Control(34)=   "Check5"
      Tab(1).Control(34).Enabled=   0   'False
      Tab(1).Control(35)=   "Check6"
      Tab(1).Control(35).Enabled=   0   'False
      Tab(1).Control(36)=   "Check7"
      Tab(1).Control(36).Enabled=   0   'False
      Tab(1).Control(37)=   "Check8"
      Tab(1).Control(37).Enabled=   0   'False
      Tab(1).Control(38)=   "Text17"
      Tab(1).Control(38).Enabled=   0   'False
      Tab(1).Control(39)=   "Text18"
      Tab(1).Control(39).Enabled=   0   'False
      Tab(1).Control(40)=   "Command15"
      Tab(1).Control(40).Enabled=   0   'False
      Tab(1).Control(41)=   "Check9"
      Tab(1).Control(41).Enabled=   0   'False
      Tab(1).Control(42)=   "Check10"
      Tab(1).Control(42).Enabled=   0   'False
      Tab(1).Control(43)=   "Check11"
      Tab(1).Control(43).Enabled=   0   'False
      Tab(1).Control(44)=   "Check12"
      Tab(1).Control(44).Enabled=   0   'False
      Tab(1).Control(45)=   "Check13"
      Tab(1).Control(45).Enabled=   0   'False
      Tab(1).Control(46)=   "Check14"
      Tab(1).Control(46).Enabled=   0   'False
      Tab(1).Control(47)=   "Check15"
      Tab(1).Control(47).Enabled=   0   'False
      Tab(1).Control(48)=   "Check16"
      Tab(1).Control(48).Enabled=   0   'False
      Tab(1).Control(49)=   "Text19"
      Tab(1).Control(49).Enabled=   0   'False
      Tab(1).Control(50)=   "Data3"
      Tab(1).Control(50).Enabled=   0   'False
      Tab(1).Control(51)=   "DBGrid3"
      ...
      Begin MSDBGrid.DBGrid DBGrid3 
         Bindings        =   "main2.frx":0070
         Height          =   3615
         Left            =   120
         OleObjectBlob   =   "main2.frx":0084
         TabIndex        =   93
         Top             =   3120
         Width           =   11295
      End
      ...
      Begin MSDBGrid.DBGrid DBGrid2 
         Bindings        =   "main2.frx":0A57
         Height          =   5175
         Left            =   -74880
         OleObjectBlob   =   "main2.frx":0A6B
         TabIndex        =   52
         Top             =   1560
         Width           =   11295
      End
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "main2.frx":143E
         Height          =   5055
         Left            =   -74880
         OleObjectBlob   =   "main2.frx":1452
         TabIndex        =   48
         Top             =   1680
         Width           =   11295
      End
...
If IsDate(Text20.Text) = False Then
...
Select Case List4.ListIndex
 ...
 End If
   ...
   If z > 0 Then
    ...
    If Check19.Value = 1 Then
    st = "select " & st4 & " from studac where year <> 'Ex' and" & st1 & str5
    End If
